...
NOTE: FROM SDK v9.0 TO HAVE SINGLE BANK DFU YOU CAN SIMPLY REPLACE dfu_dual_bank.c with dfu_single_bank.c IN THE DFU BOOTLOADER PROJECT. APPLICATION, BOOTLOADER, SOFTDEVICE UPDATE SHOULD WORK. 
